...
public class ServletAddArticle extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			request.setAttribute("error", BusinessException.BLL_EXCEPTION_CATEGORIES);
			getServletContext().getRequestDispatcher("/WEB-INF/JSP/article.jsp").forward(request, response);
		}
		request.setAttribute("listeCategory", listeCategories);
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		// retrait
		ArticleVendu article = new ArticleVendu(nomArticle, description, dateDebut, dateFin, Prix, prixDeVente,
				idUtilisateur, idCat, cheminPhoto);

		try {
			ArticleVenduManager articleVenduManager = new ArticleVenduManager();
			articleVenduManager.ajouter(article);
